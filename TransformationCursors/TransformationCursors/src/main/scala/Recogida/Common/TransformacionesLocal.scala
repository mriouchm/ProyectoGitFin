...
object TransformacionesLocal extends {
  ...
  def RecogidaInicial(date: String): Unit = {
    ...
    val SGE_SAP = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_SGE_SAP_PROVEEDORES_20220624_165906.csv.bz2").select("PROVE_NM", "PROVE_ID")
    ...
    */
    ...
    val SGR_MU_UF = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_SGR_MU_ASIG_OPERADORES_UF_TMP_20220624_165920.csv.bz2")
    ...
    val SGR_MU_UTE = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_SGR_MU_ASIG_OPERADORES_UTE_TMP_20220624_165929.csv.bz2")



    /** Este no se filtra (no tiene fechas) */
    val VM_COMUAUTO = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_COMUAUTO_20220624_171044.csv.bz2")
      .select("COMAU_ID")
    ...
    */
    ...
    val VM_ELTREPOB = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_ELTREPOB_20220624_172746.csv.bz2")
    ...
    val VM_ENTLOCAL = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_ENTLOCAL_20220624_171535.csv.bz2")
      .select("ELMUN_ID")

    val VM_ENTLTPRE = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_ENTLTPRE_20220624_172757.csv.bz2")
    ...
    */
    ...
    val VM_POBPERST = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_POBPERST_20220624_172950.csv.bz2")
      .select("UFUGA_ID", "DESDE_DT")


    val VM_TIPOLENT = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_TIPOLENT_20220624_174014.csv.bz2")
    ...
    val VM_TIPOLFAC = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_TIPOLFAC_20220624_174344.csv.bz2")
    ...
    val VM_TPRECOGI = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_TPRECOGI_20220624_174341.csv.bz2")
      .select("PROCE_ID", "TPREC_ID")

    val VM_UAACTIVI = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_UAACTIVI_20220624_174209.csv.bz2")
    ...
    val VM_UFTRGMUN = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_UFTRGMUN_20220624_174447.csv.bz2")
    ...
    val VM_UFUGACTI = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_UFUGACTI_20220624_174339.csv.bz2")
    ...
    val VM_UGACTIVI = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_UGACTIVI_20220624_174307.csv.bz2")
    ...
    val VM_UGACTMUN = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_UGACTMUN_20220624_174425.csv.bz2")
    ...
    val VM_UNIDADMI = spark.read
      .option("inferSchema", true)
      .option("header", true)
      .csv("DWE_VM_UNIDADMI_20220624_174438.csv.bz2")
    ...
    */
    ...
    val OPER_UTE_UF = spark.sql(
      """select (1 * coalesce(OP.PORCENTAJE_QT, 100) / 100) * coalesce(OU.PORCENTAJE_QT, 100) / 100 AS POBDC_QT,
        ...
        |             from SGR_MU_UTE OU  right join SGR_MU_UF_FILTERED OP on OP.UTE_ID = OU.UTE_ID""".stripMargin) // línea 35-47
    ...
    val R_JOIN_OPER_UFUGACTI = OPER_UTE_UF.alias("OPER_UTE_UF").join(VM_UFUGACTI_FILTERED.alias("VM_UFUGACTI_FILTERED"), /**VM_UFUGACTI_FILTERED("UFUGA_ID") === OPER_UTE_UF("UFUGA_ID")*/ Seq("UFUGA_ID"), "left") //Había right
    ...
    //total4.coalesce(1).write.options(Map("delimiter"->";", "emptyValue"->"NULL","header"->"true")).csv("data3.csv")


    total4.coalesce(1).writeStream.start("C:/Users/joseanto/Proyecto/data3.csv")
